  ...
  <section class="bg-white pb-16 sm:pb-20 2xl:pb-[120px]">
    <div class="wrap">
      <div
        ...
        :style="`background-color: #15112e; background-image: linear-gradient(150deg, rgba(56, 48, 132, 0.88) 0%, rgba(21, 17, 46, 0.94) 100%), url('${$asset('/enterprise-bg.png')}'); background-size: cover; background-position: center`"
      >
